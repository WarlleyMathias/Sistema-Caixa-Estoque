...
public class EstoqueDAO {
	...
	public void editar(String cod, String nome, int quantidade, float valor, float valorComprado) {
		conexao.conect();
		String sql = "UPDATE public.estoque SET nome='"+nome+"', quantidade="+quantidade+", valor="+valor+", valorComprado="+valorComprado+" WHERE cod='"+cod+"'";
		try {
