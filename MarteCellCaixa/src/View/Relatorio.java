...
public class Relatorio extends JFrame {
	...
	private JLabel lblInvestidoValor;
	private JLabel lblTotalLiquido;
	private JLabel lblTotalLiquidoValor;
	...
	public Relatorio() {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlRelatorio.buscar(trModel, table, dateChooser1, dateChooser2, lblTotalValor, lblInvestidoValor, lblTotalLiquidoValor);
			}
		});
		...
		gbl_panel_2.columnWidths = new int[]{191, 488, 0};
		gbl_panel_2.rowHeights = new int[]{35, 35, 35, 0};
		...
		GridBagConstraints gbc_lblTotalValor = new GridBagConstraints();
		gbc_lblTotalValor.fill = GridBagConstraints.BOTH;
		gbc_lblTotalValor.insets = new Insets(0, 0, 5, 0);
		gbc_lblTotalValor.gridx = 1;
		gbc_lblTotalValor.gridy = 0;
		panel_2.add(lblTotalValor, gbc_lblTotalValor);
		
		lblInvestido = new JLabel("INVESTIDO:");
		lblInvestido.setHorizontalAlignment(SwingConstants.TRAILING);
		lblInvestido.setForeground(new Color(255, 0, 0));
		lblInvestido.setFont(new Font("Tahoma", Font.PLAIN, 24));
		GridBagConstraints gbc_lblInvestido = new GridBagConstraints();
		gbc_lblInvestido.fill = GridBagConstraints.BOTH;
		gbc_lblInvestido.insets = new Insets(0, 0, 5, 5);
		gbc_lblInvestido.gridx = 0;
		gbc_lblInvestido.gridy = 1;
		panel_2.add(lblInvestido, gbc_lblInvestido);
		
		lblInvestidoValor = new JLabel("");
		lblInvestidoValor.setForeground(Color.RED);
		GridBagConstraints gbc_lblInvestidoValor = new GridBagConstraints();
		gbc_lblInvestidoValor.fill = GridBagConstraints.BOTH;
		gbc_lblInvestidoValor.insets = new Insets(0, 0, 5, 0);
		gbc_lblInvestidoValor.gridx = 1;
		gbc_lblInvestidoValor.gridy = 1;
		panel_2.add(lblInvestidoValor, gbc_lblInvestidoValor);
		
		lblTotalLiquido = new JLabel("TOTAL LIQUIDO:");
		lblTotalLiquido.setHorizontalAlignment(SwingConstants.TRAILING);
		lblTotalLiquido.setForeground(new Color(0, 255, 0));
		lblTotalLiquido.setFont(new Font("Tahoma", Font.PLAIN, 24));
		GridBagConstraints gbc_lblTotalLiquido = new GridBagConstraints();
		gbc_lblTotalLiquido.fill = GridBagConstraints.BOTH;
		gbc_lblTotalLiquido.insets = new Insets(0, 0, 0, 5);
		gbc_lblTotalLiquido.gridx = 0;
		gbc_lblTotalLiquido.gridy = 2;
		panel_2.add(lblTotalLiquido, gbc_lblTotalLiquido);
		
		lblTotalLiquidoValor = new JLabel("");
		lblTotalLiquidoValor.setForeground(Color.GREEN);
		GridBagConstraints gbc_lblTotalLiquidoValor = new GridBagConstraints();
		gbc_lblTotalLiquidoValor.fill = GridBagConstraints.BOTH;
		gbc_lblTotalLiquidoValor.gridx = 1;
		gbc_lblTotalLiquidoValor.gridy = 2;
		panel_2.add(lblTotalLiquidoValor, gbc_lblTotalLiquidoValor);
